...
class AirlineEvent(models.Model):
    ...
    is_weekend = models.CharField(blank=True, null=True)
    is_oneway = models.CharField(blank=True, null=True)
    is_event = models.CharField(blank=True, null=True)
    discount_type = models.CharField(blank=True, null=True, max_length=10)
    duplicate = models.CharField(blank=True, null=True)
